...
namespace gescom.create.Views
{
    public partial class XtraJournal : XtraForm
    {
        ...
        private void Init(long id)
        {
            ...
            if (item.Qachat is null) { item.Qachat = 0; }
