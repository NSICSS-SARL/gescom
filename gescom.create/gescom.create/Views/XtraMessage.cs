...
namespace gescom.create.Views
{
    public partial class XtraMessage : XtraForm
    {
        ...
        private void creer_Click(object sender, EventArgs e)
        {
            ...
            var message = s1.Text;
            var quantite = float.Parse(q1.Text);
            if (_index == 1)
            {
                ...
                if (checkPrix.Checked) _x = 1;
                if (checkEntre.Checked) _y = 1;
                ArticleHelpers.UpdateRecto(_id, t1.Text, message, quantite, b1.Text, b2.Text, _x, _y);
            }

            if (_index == 2) ArticleHelpers.UpdateDuo(_id, message, quantite);
            Close();
        }
        ...
        private void Init()
        {
            ...
            codage.Text = fcode;
            var duo = ArticleHelpers.GetDuo(_id);
            ...
            if (_x == 0) checkEntre.Checked = true;
            if (_y == 0) checkPrix.Checked = true;
            if (_index == 1)
            {
                s.Text = duo.S2;
