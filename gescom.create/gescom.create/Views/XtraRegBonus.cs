    ...
    public partial class XtraRegBonus : XtraForm
    {
        ...
        private void CheckSituation(long id)
        {
           /* var state = SituationHelpers.Get(id);
            ...
            switch (commerce)
            {
                case "CMD": commCMD.Checked = true; break;
                case "SPD": radioSPD.Checked = true; break;
                case "STOP": dangerBtn.Checked = true; break;
                default: commRS.Checked = true; break;
            }
            var frns = state.Fournisseur;
            switch (frns)
            {
                case "En rupture": radioRupt.Checked = true; break;
        ...
        public void SituationSave()
        {
            ...
            if (dangerBtn.Checked)
            {
                cce = "STOP";
            }
            if (radioRupt.Checked)
            {
                frns = "En rupture";
            }
            if (radioPuise.Checked)
            {
                frns = "Epuisé";
            }
            if (radioBB.Checked)
